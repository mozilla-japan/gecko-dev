...
const char* OmxCoreLibLinker::sLibNames[] = {
  "/usr/local/lib/libomxr_core.so", // Renesas (RZ/G): Our first target
  "/usr/lib/libomxr_core.so", // Renesas (R-Car): Our second target
  "/opt/vc/lib/libopenmaxil.so", // Raspberry Pi: Our postponed target
